...
class Mailer:
    ...
    def __init__(self):
        ...
        # E.g., "email@gmail.com"
        self.EMAIL = "nandinipola01@gmail.com"
        ...
        self.PASS = "Nandini@01"
        self.PORT = 465
        self.server = smtplib.SMTP_SSL('smtp.gmail.com', self.PORT)

    def send(self, mail,name,location):
        self.server = smtplib.SMTP_SSL('smtp.gmail.com', self.PORT)
        self.server.login(self.EMAIL, self.PASS)
        # message to be sent
        SUBJECT = 'ALERT!'
        TEXT = f'Criminal Found'
        message = 'Criminal Name: {}\n Location Found :\n{}'.format(name,location)

        # sending the mail
        self.server.sendmail(self.EMAIL, mail,'Criminal {} found in location {} !'.format(name,location))
        self.server.quit()
